...
public class libSalesData {
    private String bill_id, bill_name, bill_date, total_b_desc,disc,total_a_desc,tax14,total_a_tax;

    public libSalesData(String bill_id, String bill_name, String bill_date, String total_b_desc,String disc
            ,String total_a_desc,String tax14,String total_a_tax) {
    ...
    public void setTax14(String tax14) {
        this.tax14 = tax14;
    }  public String getTotal_a_tax() {
        return this.total_a_tax;
    }

    public void setTotal_a_tax(String total_a_tax) {
        this.total_a_tax = total_a_tax;
    }
}